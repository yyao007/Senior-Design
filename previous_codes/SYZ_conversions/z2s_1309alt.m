function [snp, err, errmsg] = z2s_1309alt(znp)
%% Description: converts Z-parameters to S-parameters using the alternative formula
% S = [U/(Z+Z0u)] * (Z-Z0u)
...
% Note: this formula is different from the formular in z2s_1309a which is
%       S = (Z-Z0u)/(Z+Z0u)  
